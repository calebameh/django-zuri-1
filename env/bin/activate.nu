...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/caleb/Desktop/Zuri Training/django-zuri/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/caleb/Desktop/Zuri Training/django-zuri/env/bin/deactivate.nu'
